...
export const services6 = [
  {
    ...
    title: "التأسيس المالي",
    text: "بناء النظام المحاسبي وتأسيس شجرة الحسابات وبناء الإجراءات المالية للمنــــــــــشأة والتدريب",
    src: "/assets/images/services-icons/FinancialFoundation.svg",
  },
  {
    width: 60,
    height: 64,
    ...
    text: "التدقيق والمراجــــعة لمهمة مالــــــية للفترة السابقة وإصدار تقرير محاسبي يحدد المعايير المطلوبة للمنشأة",
    src: "/assets/images/services-icons/ReviewAndAudit.svg",
  },
  {
    width: 50,
    height: 64,
    ...
    text: "إغلاق ورفع الإقرارات الضريبية لكل ربع مالي حــــــسب معايير هـــــيئة الزكــــاه والدخل",
    src: "/assets/images/services-icons/ZakatAndTax.svg"
  },
  {
    width: 48,
    height: 64,
    ...
    title: "دراسة الجــــدوى",
    text: "نقدم دراسة جدوى مفصلة من أرض الواقع بعد تجميع بيانات واقعية وتحلــــــــيلها على يد خبراء في المجال.",
    src: "/assets/images/services-icons/FeasibilityStudy.svg"
  },
  {
    width: 48,
    height: 64,
    ...
    title: "تسجيل الدفاتر",
    text: "تسجيل القيود اليومية وأرشـفة الملفات الورقية أسبوعيا لدى المنشأة على النظام المالي المحدد.",
    src: "/assets/images/services-icons/BookKeeping.svg"
  },
  {
    width: 48,
    height: 64,
    ...
    text: "في هذه الخدمة يتم معالجة البيانات المالية للمنشأة بهدف حصولها على معلومات تساعدها في اتخاذ القرارات وتقييم الأداء في الماضي والحاضر والتنبؤ فيما ستكون عليه بالمستقبل.",
    src: "/assets/images/services-icons/Financial-analysis.svg"
  },
  {
    width: 48,
    height: 64,
    path: "M44.25 20c2.25 0 3.75 1.625 3.75 3.875v22c0 2.25-1.5 4.125-3.75 4.125h-40c-2.25 0-4.25-1.875-4.25-4.125v-22c0-2.25 2-3.875 4.25-3.875h1.625v-2h4.25v2h1.625c4-4.5 5.375-6 6.875-6h11c1.5 0 2.875 1.5 6.875 6h7.75zM46 45.875v-22c0-1.125-0.625-1.875-1.75-1.875h-8.625l-0.625-0.375c-0.375-0.5-0.875-1-1.25-1.375-1.5-1.625-2.5-3-3.25-3.75-0.625-0.625-0.875-0.5-0.875-0.5h-11s-0.25 0-0.875 0.5c-0.75 0.625-1.75 1.75-3.125 3.375-0.375 0.5-0.875 1.25-1.375 1.75l-0.625 0.375h-8.375c-1.125 0-2.25 0.875-2.25 1.875v22c0 1.125 1.125 2.125 2.25 2.125h40c1 0 1.75-1 1.75-2.125zM24 23.75c5.875 0 10.75 4.75 10.75 10.625s-4.875 10.625-10.75 10.625-10.75-4.75-10.75-10.625 4.875-10.625 10.75-10.625zM24 43c4.75 0 8.75-3.875 8.75-8.625s-4-8.625-8.75-8.625-8.75 3.875-8.75 8.625 4 8.625 8.75 8.625zM36 26.125v-2.125h2.125v2.125h-2.125zM20 34.375c0-2.625 1.375-4 4-4s4 1.375 4 4-1.375 4-4 4-4-1.375-4-4z",
    title: "الاشراف المحاسبي",
    text: "في هذه الخدمة نقوم بالاشراف على المحاسبين الخاصين بالمنشأة ومتابعة أعمالهم وسيرها بالشكل الصحيح لتقديم التقارير خاليةً من الأخطاء.",
    src: "/assets/images/services-icons/Accounting-supervision.svg"
  },
  {
    width: 48,
    height: 64,
    path: "M44.25 20c2.25 0 3.75 1.625 3.75 3.875v22c0 2.25-1.5 4.125-3.75 4.125h-40c-2.25 0-4.25-1.875-4.25-4.125v-22c0-2.25 2-3.875 4.25-3.875h1.625v-2h4.25v2h1.625c4-4.5 5.375-6 6.875-6h11c1.5 0 2.875 1.5 6.875 6h7.75zM46 45.875v-22c0-1.125-0.625-1.875-1.75-1.875h-8.625l-0.625-0.375c-0.375-0.5-0.875-1-1.25-1.375-1.5-1.625-2.5-3-3.25-3.75-0.625-0.625-0.875-0.5-0.875-0.5h-11s-0.25 0-0.875 0.5c-0.75 0.625-1.75 1.75-3.125 3.375-0.375 0.5-0.875 1.25-1.375 1.75l-0.625 0.375h-8.375c-1.125 0-2.25 0.875-2.25 1.875v22c0 1.125 1.125 2.125 2.25 2.125h40c1 0 1.75-1 1.75-2.125zM24 23.75c5.875 0 10.75 4.75 10.75 10.625s-4.875 10.625-10.75 10.625-10.75-4.75-10.75-10.625 4.875-10.625 10.75-10.625zM24 43c4.75 0 8.75-3.875 8.75-8.625s-4-8.625-8.75-8.625-8.75 3.875-8.75 8.625 4 8.625 8.75 8.625zM36 26.125v-2.125h2.125v2.125h-2.125zM20 34.375c0-2.625 1.375-4 4-4s4 1.375 4 4-1.375 4-4 4-4-1.375-4-4z",
    title: "ربط المتاجر الالكترونية",
    text: "في هذه الخدمة نقوم بتهيئة نظام محاسبي سحابي وربطة مع المتاجر الالكترونية التابعين لسلة وزد لربط الإيرادات فيه، ويتم ادخال المصروفات والمشتريات وحساب التكاليف بشكل يدوي.",
    src: "/assets/images/services-icons/Linking-e-commerce-stores.svg"
  },
];
